...
A Quizz console game. In this program there is a text file containing questions and answers, a player goes through a quizz and can win points by answering correctly!
The following topics are covered: `User Input`, `Random Object`, `While loops`, `Lists` and `Conditional Statements`.
